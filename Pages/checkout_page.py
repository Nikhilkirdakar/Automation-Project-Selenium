...
class CheckoutPage(BasePage):
    ...
    def finalize(self, first_name, last_name, pincode):
        ...
        WebDriverWait(self.driver, 10).until(EC.element_to_be_clickable(self.finish))
        self.take_screenshot("before_finish")
        self.driver.find_element(*self.finish).click()

        WebDriverWait(self.driver, 10).until(EC.visibility_of_element_located(self.text))
